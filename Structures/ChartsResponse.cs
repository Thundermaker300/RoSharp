...
namespace RoSharp.Structures
{
    ...
    {
        /// <summary>
        /// Gets the token that can be used in the cursor parameter of <see cref="GameAPI.GetFrontPageExperiencesAsync(Session?, ChartsFilterOptions?, string?)"/> to advance to the next page.
        /// </summary>
