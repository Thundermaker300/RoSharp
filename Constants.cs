...
namespace RoSharp
{
    ...
    public static class Constants
    {
        ...
        public static readonly ReadOnlyDictionary<string, ExperienceDescriptorType> DescriptorIdToEnumMapping = new Dictionary<string, ExperienceDescriptorType>()
        {
            ...
            ["continuous-media-feed"] = ExperienceDescriptorType.ContinuousMediaFeed,
            ...
            ["media-sharing"] = ExperienceDescriptorType.MediaSharing,
            ["media-viewing"] = ExperienceDescriptorType.MediaViewing,
            ["paid-item-trading"] = ExperienceDescriptorType.PaidItemTrading,
            ["paid-random-items"] = ExperienceDescriptorType.PaidRandomItems,
