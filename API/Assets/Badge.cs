...
namespace RoSharp.API.Assets
{
    ...
    public class Badge : APIMain, IRefreshable, IIdApi<Badge>
    {
        ...
        /// <summary>
        /// Retrieves a thumbnail URL for this badge. The <paramref name="retries"/> parameter can optionally be set to retry retrieving the thumbnail if it has not loaded yet.
        /// </summary>
        ...
        public async Task<HttpResult<string>> GetThumbnailAsync(int retries = -1)
        {
